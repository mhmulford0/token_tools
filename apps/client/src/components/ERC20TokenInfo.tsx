...
export default function ERC20TokenInfo(props: { apiData: ApiResponse }) {
  ...
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-md prose">
      <div className="overflow-hidden bg-white shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-gray-900">Token Information</h3>
        </div>
          ...
          <dl className="sm:divide-y sm:divide-gray-200">
            ...
            <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                ...
                <>
                  {wallet === address ? (
                    <div className="inline ml-[0.5ch] text-gray-500 italic font-bold hover:underline cursor-pointer">
                      Transfer
                    </div>
                  ) : (
                    ""
